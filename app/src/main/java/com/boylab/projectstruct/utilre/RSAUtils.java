...
public class RSAUtils {
    ...
    // 这个签名算法，对应openssl中的签名算法sha1
    private static final String SIGNATURE_ALGORITHM = "SHA1withRSA";
    // 这个加密算法，对应CryptoPP里面的解密算法 RSAES_OAEP_SHA_Decryptor
    private static final String TRANSFORMATION_ALGORITHM = "RSA/ECB/OAEPwithSHA-1andMGF1Padding";
    // 这个加密算法，在CryptoPP里面，使用 RSAES_PKCS1v15_Decryptor 一直提示密文长度不对，要128实际才125 126 127等等
